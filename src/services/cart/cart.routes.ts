...
export class CartRoutes{
    ...
    getRoutes(): Router {
        ...
        this.router.post('/cart/add', (req: Request, res: Response, next: NextFunction) => auth(req,res,next, this.cartController.cartService.userRepository)
            , (req: Request, res: Response) => this.cartController.addItems(req, res))
        this.router.post('/cart/remove', (req: Request, res: Response, next: NextFunction) => auth(req,res,next, this.cartController.cartService.userRepository)
            , (req: Request, res: Response) => this.cartController.removeItems(req, res))
        this.router.post('/cart/checkout', (req: Request, res: Response, next: NextFunction) => auth(req,res,next, this.cartController.cartService.userRepository)
